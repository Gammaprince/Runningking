...
public class webview extends AppCompatActivity implements AdvancedWebView.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        } else if (gateway.equalsIgnoreCase("coinpayments")){
            mWebView.loadUrl(constant.project_root+"coinpayments/examples/create_simple_transaction.php?amount="+amount+"&user="+getSharedPreferences(constant.prefs,MODE_PRIVATE).getString("mobile", null));
        } else {
