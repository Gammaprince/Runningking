...
public class starline_games extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        single.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                single();
                startActivity(new Intent(starline_games.this, betting.class).putExtra("market", market).putExtra("list", number).putExtra("game", "single").putExtra("timing",timing).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
            }
        });
